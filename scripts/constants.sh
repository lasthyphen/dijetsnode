...
DIJETSPATH=$( cd "$( dirname "${BASH_SOURCE[0]}" )"; cd .. && pwd ) # Directory above this script

# Where DijetsNode binary goes
...
coreth_path=${CORETH_PATH:-"$GOPATH/pkg/mod/github.com/lasthyphen/utilitychain@$coreth_version"}
...
dijetsnode_dockerhub_repo=${DOCKER_REPO:-"dijetsnode"}
