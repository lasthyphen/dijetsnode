...
echo "Building docker image based off of most recent local commits of dijetsnode and coreth"

AVALANCHE_REMOTE="git@github.com:lasthyphen/dijetsnode.git"
...
AVALANCHE_CLONE="$WORKPREFIX/dijetsnode"
...
AVALANCHE_COMMIT_HASH="$(git -C "$EXISTING_GOPATH/$AVA_LABS_RELATIVE_PATH/dijetsnode" rev-parse --short HEAD)"
